...
export function CourseCardSkeleton() {
  return (
    <Card className='flex flex-col h-full overflow-hidden shadow-none'>
      <Skeleton className='h-48 w-full bg-slate-300' />
      <CardHeader>
      ...
      <CardContent className='flex-grow'>
        ...
        <div className='flex items-center justify-between text-sm text-gray-500'>
          ...
          <div className='flex items-center'>
            ...
            <Skeleton className='h-4 w-8 bg-slate-300' />
          </div>
        </div>
      </CardContent>
      <CardFooter className='flex justify-between items-center'>
        <Skeleton className='h-8 w-20 bg-slate-300' />
        <Skeleton className='h-10 w-2 bg-slate-3008' />
      </CardFooter>
    </Card>
  );
}
